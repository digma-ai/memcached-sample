...
public class BookController {
    ...
    @GetMapping("/trigger-memcached/{key}/{value}")
    public void triggerMemcached(@PathVariable String key, @PathVariable String value) {
        MemcachedExample.setGetRemoveFromMemcached(key, value);
    }
